...
set rc [catch {
  ...
  open_checkpoint ZYNQ_implement_routed.dcp
  ...
  catch { write_mem_info -force ZYNQ_implement.mmi }
  write_bitstream -force ZYNQ_implement.bit 
  catch {write_debug_probes -quiet -force ZYNQ_implement}
  catch {file copy -force ZYNQ_implement.ltx debug_nets.ltx}
